...
- 直接ダウンロード: <https://github.com/freee/freee-mcp/releases/latest/download/freee-api-skill.zip>
- バージョン履歴から選ぶ場合: [Releases](https://github.com/freee/freee-mcp/releases) ページ
